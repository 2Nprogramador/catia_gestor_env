...
def init_dataframes():
    try:
        ...
        vendas_df = pd.DataFrame(
            columns=["Código da Venda", "Produto", "Lote", "Quantidade", "Método de Pagamento", "Data da Venda",
    ...
    try:
        ...
        registro_estoque_df = pd.DataFrame(
            columns=["Produto", "Lote", "Quantidade", "Data de Entrada", "Data de Validade", "Custo (R$)",
                     "Valor de Venda (R$)"])
